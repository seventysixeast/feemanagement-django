document.addEventListener("DOMContentLoaded", function () {
  ...
  async function feesformonths(a, b) {
    ...
    var mf = document.getElementById("id_fees_for_months").value;
    ...
    if (mf != "") {
      ...
      /* var selectedMonthString = selectedMonthValues.join(",");
      var url = "/studentFees/Calculatefees"; // Assuming you're adapting to Django
      ...
      $.ajax({
        ...
        success: function (data) {
          if (data != "-----------") {
            ...
            document.getElementById("annual_fees_paid").value = d[0]; // Updated: annual_fees_paid
            document.getElementById("tuition_fees_paid").value =
              d[1] > 0 ? d[1] : "0"; // Updated: tuition_fees_paid
            document.getElementById("funds_fees_paid").value =
              d[2] > 0 ? d[2] : "0"; // Updated: funds_fees_paid
            document.getElementById("sports_fees_paid").value =
              d[3] > 0 ? d[3] : "0"; // Updated: sports_fees_paid
            document.getElementById("admission_fees_paid").value = d[4]; // Updated: admission_fees_paid
            document.getElementById("dayboarding_fees_paid").value =
              d[6] > 0 ? parseInt(d[6]) : "0"; // Updated: dayboarding_fees_paid
            document.getElementById("bus_fees_paid").value =
              d[7] > 0 ? parseInt(d[7]) : "0"; // Updated: bus_fees_paid
            document.getElementById("activity_fees").value = parseInt(d[10]); // Updated: activity_fees
            document.getElementById("concession_type_id").value = d[12]; // Updated: concession_type_id
            document.getElementById("concession_applied").value = d[13]; // Updated: concession_applied
            document.getElementById("miscellaneous_fees_paid").value = d[14]; // Updated: miscellaneous_fees_paid
            document.getElementById("late_fees_paid").value = d[15]; // Updated: late_fees_paid

            var tot = d[16];
            document.getElementById("total_amount").value = tot; // Updated: total_amount
            document.getElementById("amount_paid").value = tot; // Updated: amount_paid
          } else {
